...
//Contrato registro de notas ---- utiliza calculadora
contract RegistroDeNotas is Ownable{
    ...
    constructor(address _addressCalculadora) Ownable(msg.sender){
        addressCalculadora = _addressCalculadora; //guarda la dirección del contrato caluladora de manera dinámica
    }
